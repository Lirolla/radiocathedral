...
export const SkipBackIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M18.945 7.06c1.25-.714 2.805.189 2.805 1.628v8.123c0 1.44-1.555 2.342-2.805 1.628L12 14.471v2.34c0 1.44-1.555 2.342-2.805 1.628L2.087 14.38c-1.26-.72-1.26-2.536 0-3.256L9.195 7.06C10.445 6.346 12 7.25 12 8.688v2.34l6.945-4.061z" />
  </svg>
);
...
export const MusicIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.696 2.112l-1.37.342a2.25 2.25 0 01-2.06-2.657l.5-1.5a2.25 2.25 0 012.06-1.556h.579m-12.722-1.16l-.285-.95a2.25 2.25 0 011.666-2.825l.855-.214a2.25 2.25 0 012.56 1.34l.285.95a2.25 2.25 0 01-1.666 2.825l-.855.214a2.25 2.25 0 01-2.56-1.34z" />
  </svg>
);
...
export const MicOffIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 19.5l-15-15m0 0v1.5m0 0v4.5m0 0a6 6 0 006 6m6-6v-1.5m0 0V4.5m0 0a3 3 0 00-3-3m0 0a3 3 0 00-3 3m0 0v1.5m0 0a6 6 0 01-6 6" />
  </svg>
);
...
export const PhoneOffIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 3.75L18 6m0 0l2.25 2.25M18 6l2.25-2.25M18 6l-2.25 2.25m1.5 13.5c-8.284 0-15-6.716-15-15V4.5A2.25 2.25 0 014.5 2.25h1.372c.516 0 .966.351 1.091.852l1.106 4.423c.11.44-.055.902-.417 1.173l-1.293.97a1.062 1.062 0 00-.38 1.21 12.035 12.035 0 017.143 7.143c.441.162.928-.004 1.21-.38l.97-1.293a1.125 1.125 0 011.173-.417l4.423 1.106c.5.125.852.575.852 1.091V19.5a2.25 2.25 0 01-2.25 2.25h-2.25z" />
  </svg>
);

export const BroadcastIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 01-1.161.886l-.143.048a1.107 1.107 0 00-.57 1.664c.369.555.169 1.307-.413 1.605-1.029.527-2.551-1.66-2.551-3.016V5.25c0-.864.522-1.632 1.309-1.93l.354-.132a2.25 2.25 0 011.002-.079l.522.09c.47.081.93.003 1.353-.228.609-.333 1.354-.153 1.758.38l.412.548a.563.563 0 00.354.218zM18 10.5h.008v.008H18V10.5zm-3 0h.008v.008H15V10.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 19.5h19.5m-16.5-12h13.5a2.25 2.25 0 012.25 2.25v6.75a2.25 2.25 0 01-2.25-2.25H5.25a2.25 2.25 0 01-2.25-2.25v-6.75a2.25 2.25 0 012.25-2.25z" />
  </svg>
);
